      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h1 className="text-3xl sm:text-5xl font-light text-[#F8F9FA] tracking-tight mb-4">
            WHO WE <span className="font-extrabold text-[#F5DE88]">ARE</span>
          </h1>
        ...
        <div className="p-8 sm:p-12 rounded-3xl bg-[#141820] border border-white/[0.08] shadow-2xl mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-4 text-center lg:text-left border-b lg:border-b-0 lg:border-r border-white/[0.08] pb-8 lg:pb-0 lg:pr-8">
              <div className="text-7xl font-black text-[#F5DE88] leading-none mb-2">
                20+
              </div>
              <div className="text-lg font-bold text-[#F8F9FA] uppercase tracking-wider mb-2">
            ...
            <div className="lg:col-span-8 space-y-4">
              <h2 className="text-2xl sm:text-3xl font-bold text-[#F8F9FA]">
