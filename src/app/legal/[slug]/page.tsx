...
const LEGAL_DOCS: Record<string, { title: string; subtitle: string; content: React.ReactNode }> = {
  "content-submission-policy": {
    ...
    content: (
      <div className="space-y-6 text-[#94A3B8] text-sm leading-relaxed">
        <section>
          <h3 className="text-lg font-bold text-[#F8F9FA] mb-2">1. Scope of Submission</h3>
          <p>
        ...
        <section>
          <h3 className="text-lg font-bold text-[#F8F9FA] mb-2">2. Warranty of Authority</h3>
          <p>
        ...
        <section>
          <h3 className="text-lg font-bold text-[#F8F9FA] mb-2">3. Confidentiality &amp; Non-Disclosure</h3>
          <p>
        ...
        <section>
          <h3 className="text-lg font-bold text-[#F8F9FA] mb-2">4. Legal Review Notice</h3>
          <p className="p-4 rounded-2xl bg-[#181D26] border border-white/10 text-xs text-[#CBD5E1]">
  ...
  "privacy-policy": {
    ...
    content: (
      <div className="space-y-6 text-[#94A3B8] text-sm leading-relaxed">
        <section>
          <h3 className="text-lg font-bold text-[#F8F9FA] mb-2">1. Information Collection</h3>
          <p>
        ...
        <section>
          <h3 className="text-lg font-bold text-[#F8F9FA] mb-2">2. Data Security &amp; Access Controls</h3>
          <p>
  ...
  "terms-and-conditions": {
    ...
    content: (
      <div className="space-y-6 text-[#94A3B8] text-sm leading-relaxed">
        <section>
          <h3 className="text-lg font-bold text-[#F8F9FA] mb-2">1. Acceptance of Terms</h3>
          <p>
        ...
        <section>
          <h3 className="text-lg font-bold text-[#F8F9FA] mb-2">2. Intellectual Property</h3>
          <p>
  ...
  "copyright-disclaimer": {
    ...
    content: (
      <div className="space-y-6 text-[#94A3B8] text-sm leading-relaxed">
        <section>
          <h3 className="text-lg font-bold text-[#F8F9FA] mb-2">1. Project Trademarks &amp; Artwork</h3>
          <p>
        ...
        <section>
          <h3 className="text-lg font-bold text-[#F8F9FA] mb-2">2. Commercial Disclaimer</h3>
          <p>
  ...
  return (
    <div className="pt-32 pb-24 bg-[#090B0D] min-h-screen relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-xs font-bold font-mono tracking-widest text-[#F5DE88] uppercase mb-8 hover:text-[#FCEEAC] transition-colors"
        >
          <ArrowLeft className="w-4 h-4" />
          <span>Back to Homepage</span>
        </Link>

        <div className="rounded-3xl bg-[#141820] border border-white/[0.08] p-8 sm:p-12 shadow-2xl">
          <div className="border-b border-white/[0.08] pb-6 mb-8">
            <h1 className="text-2xl sm:text-4xl font-bold text-[#F8F9FA] mb-2">
              {doc.title}
            </h1>
            <p className="text-xs text-[#F5DE88] tracking-wider font-mono uppercase font-semibold">
              {doc.subtitle}
            </p>
          </div>
          ...
          <div className="mt-12 pt-6 border-t border-white/[0.08] text-[11px] text-[#64748B] font-mono flex items-center justify-between">
